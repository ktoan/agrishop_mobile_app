export const checkStringContaining = (string1, string2) => {
  const regex = new RegExp(string2, 'i');
  if (string1.match(regex)) return true;
  return false;
};

export const convertSQLDateToStringDate = date => {
  return date.split('T')[0] || 'String is not sql date';
};
